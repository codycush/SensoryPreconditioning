...
*/
  ...
  var lthVal=lthval;
  var step=Step;
//  console.log(bgVal,lthVal,step)

  var centerOffset = 200; //how far to offset target circles from screen center
...
//variables from the matlab code
  var preStimInterval = randomNumberBetween(400,600)
  var trials = 30;
  ...
  var consecutiveCorrect=consecutive_correct;
  var consecutiveIncorrect=consecutive_incorrect;
...
window.setTimeout(animateDotFlicker,preStimInterval)
